...
- **Model**: 7-level with degenerate $\pm 1$ spin states
- **Contrast**: ~17% at $\Gamma$ = 0.1 MHz (both MW)
- Files:
...
- **Contrast**: ~1% ($-$), ~15% ($+$) at $\Gamma$ = 0.1 MHz
- Files: Same structure as nv_bulk
