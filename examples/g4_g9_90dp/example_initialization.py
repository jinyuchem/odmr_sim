#!/usr/bin/env python3
"""
Initialization simulation for G4-G9 NV configuration at 90 degrees.

This example demonstrates spin polarization dynamics using g4_g9_90dp preset.
"""
...
def main():
    ...
    for i, (gamma, result) in enumerate(zip(gammas, results)):
        plot_populations(
            ...
            title=f"G4-G9 90dp Initialization",
            xlim=(1, 1e6),
            ylim=(-0.05, 1.05),
        )
    ...
    plt.tight_layout()
    plt.savefig("g4_g9_90dp_initialization.pdf", bbox_inches='tight', dpi=300)
    plt.show()
