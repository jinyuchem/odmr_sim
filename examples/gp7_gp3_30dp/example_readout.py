#!/usr/bin/env python3
"""
Readout simulation for GP7-GP3 NV configuration at 30 degrees.

This example demonstrates optical readout dynamics using gp7_gp3_30dp preset.
"""
...
def main():
    ...
    plot_readout_comparison(
        ...
        xlim=(-50, 1200),
        ylim=(0, 0.2),
        title=f"GP7-GP3 30dp Readout Dynamics ($\\Gamma$ = {gamma} MHz)"
    )

    plt.tight_layout()
    plt.savefig("gp7_gp3_30dp_readout.pdf", bbox_inches='tight', dpi=300)
    plt.show()
