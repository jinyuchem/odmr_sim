#!/usr/bin/env python3
"""
Initialization simulation for GP7-GP3 NV configuration at 30 degrees.

This example demonstrates spin polarization dynamics using gp7_gp3_30dp preset.
"""
...
def main():
    ...
    for i, (gamma, result) in enumerate(zip(gammas, results)):
        plot_populations(
            ...
            title=f"GP7-GP3 30dp Initialization",
            xlim=(1, 1e6),
            ylim=(-0.05, 1.05),
        )
    ...
    plt.tight_layout()
    plt.savefig("gp7_gp3_30dp_initialization.pdf", bbox_inches='tight', dpi=300)
    plt.show()
