#!/usr/bin/env python3
"""
Initialization simulation for G9-G8 NV configuration at 30 degrees.

This example demonstrates spin polarization dynamics using g9_g8_30dp preset.
"""
...
def main():
    ...
    for i, (gamma, result) in enumerate(zip(gammas, results)):
        plot_populations(
            ...
            title=f"G9-G8 30dp Initialization",
            xlim=(1, 1e8),
            ylim=(-0.05, 1.05),
        )
    ...
    plt.tight_layout()
    plt.savefig("g9_g8_30dp_initialization.pdf", bbox_inches='tight', dpi=300)
    plt.show()
